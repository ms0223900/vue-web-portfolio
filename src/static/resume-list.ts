const resumeList = [
  ...
  ### 程式風格
    ...
    演算法方面，前陣子練習完整本「王者歸來」書中的演算法範例，原書的範例皆為python語法，因此用python寫了一次，並且邊寫邊重構，而非照抄範例而已。此外還用JavaScript寫一遍，讓印象更為深刻。
  ### 合作經驗較少
    ...
    雖然相關經驗比較少，但也是有幾個值得一提的經驗，其中一個就是去年參與了g0v的專案(<a href="https://github.com/g0v/2020voting-guide" target="_blank">https://github.com/g0v/2020voting-guide</a>)，在某次參加黑客松的契機之下加入了專案的協作，成為其中的一員，而我主要是負責搜尋的功能。這是第一次參與這類型的多人協作專案，成員都是在網路上遠端溝通，幾乎沒有面對面的討論，但專案仍然順利進行，討論都還算順暢，最後也趕在大選之前順利完成，是個難得的經驗。`,
  },
];
